					...
					<?php
					  $id=$_SESSION['m_id'];
						...
						if (isset($_GET["page"])) 
						  ...
						  $welcome_view = "SELECT * FROM PROGRAM WHERE P_ID IN(SELECT P_ID FROM CONDUCTS WHERE M_ID = '$id')";
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="table-responsive">
					<?php				
						$sql = "SELECT * FROM PROGRAM WHERE P_ID IN(SELECT P_ID FROM CONDUCTS WHERE M_ID = '$id')";		
						$qry=mysql_query($sql);
					?>
...
<?php
		...
		echo ' '.$_REQUEST["page"].' ';
				for($i=1; $i<=$total_pages; $i++ )
					{
						 echo"<ul class='pagination '> <li>&nbsp<a href = 'mentor_programs.php?page=".$i."'>".$i."</a></li></ul>";
					}
						echo'&nbsp&nbsp';
?>
</div>

	...
	<div class="container-fluid">
		...
		<?php
			...
			if (isset($_POST['submit'])) 
			{
			     ...
			     $result=mysql_query("select * from student where s_email='$UserName' and s_cellno='$Password' ")or die (mysql_error());
			    ...
			    if ($count > 0)
			    {
			      ...
			      $_SESSION['s_id']=$row['s_id'];
			       header('location:admin_student.php?id='.$row['s_id'].'');
			    }
			    else
			    {
			...
			<div class="col-md-6" style = "margin-top:110px;">
				<div class="panel panel-default">
				   <div class="page-header">
					  <h1 style = "margin-left:50px;">Student <small>Login</small></h1>
					</div>
					<div class="panel-body">
						<form method="post" action="login_student.php" class="form-horizontal" role="form">

					...
					<table class="table table-hover">
						...
						<tbody>
							<tr>
									...
									<td>
										<a href='query_view.php?id=<?php echo $rec['q_id']?>' data-toggle="tooltip" data-placement="top" title="View"><span class="glyphicon glyphicon-list-alt" style="font-size:20px; color:red"></span></a>
									</td>
									
									<td>
										<a href='edit_query.php?id=<?php echo $rec['q_id']?>'data-toggle="tooltip" data-placement="top" title="Edit Information"><span class="glyphicon glyphicon-edit" style="font-size:20px; color:green"></span></a>
									</td>
					<?php
						}
					?>

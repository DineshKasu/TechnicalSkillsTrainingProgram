		...
		<form method="post" class="form-horizontal">
						...
						<div class = "col-md-10 col-md-offset-2">
							...
							<div class="form-group" >
							  ...
							  <div class="col-md-3">
							  <input id="q_query" name="q_query" type="text" value = "<?php echo $q_query;?>" placeholder="Query" class="form-control input-md" required="">
							  </div>
							</div>
							...
							<div class="form-group" >
							  ...
							  <div class="col-md-4">
							  <input id="q_ans" name="q_ans" type="text" value = "<?php echo $q_ans;?>" placeholder="Answer" class="form-control input-md" required="">
							  </div>
							</div>   

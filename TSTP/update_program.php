					...
					<table class="table table-hover">
						...
						<tbody>
							<tr>
									...
									<td>
										<a href='edit_program.php?id=<?php echo $rec['p_id']?>'data-toggle="tooltip" data-placement="top" title="Edit Information"><span class="glyphicon glyphicon-edit" style="font-size:20px"></span></a>
									</td>
									<!--<td>
										
										<a href='prog_stat.php?id=<?php echo $rec['p_id']?>' data-toggle="tooltip" data-placement="top" title="Delete Program"><span class="glyphicon glyphicon-trash" style="font-size:20px; color:red"></span></a>
									</td> -->

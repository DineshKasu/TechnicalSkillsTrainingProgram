	...
	<div class="container-fluid">
		...
		<?php
			...
			if (isset($_POST['submit'])) 
			{
			     ...
			     $result=mysql_query("SELECT * FROM DIRECTOR WHERE D_EMAIL='$UserName' AND D_CELLNO='$Password' ")or die (mysql_error());
			    ...
			    if ($count > 0)
			    {
				 ...
				 // echo "success"; 
			      header('location:admin_director.php?id='.$row['d_id'].'');
			    }
			    else
			    {
			...
			<div class="col-md-6" style = "margin-top:110px;">
				<div class="panel panel-default">
				   <div class="page-header">
					  <h1 style = "margin-left:50px;">Director <small>Login</small></h1>
					</div>
